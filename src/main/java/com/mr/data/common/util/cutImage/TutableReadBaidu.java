...
public class TutableReadBaidu extends HttpServlet {
	...
	// 注册百度有设置APPID/AK/SK
	public static final String APP_ID = "11641746";
	public static final String API_KEY = "amGikVFG3DMxS70DorUNUlvR";
	public static final String SECRET_KEY = "1Ze4bta22sW70V5bvlexbnB8b5kbNXqG";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		/*******************************************/
		Mat src = Imgcodecs.imread("C:\\Users\\Space\\Desktop\\" + request.getParameter("name") + ".jpg");
		if (src.empty()) {
