package com.mr.data.common.aop;


import com.mr.data.common.annotation.OperationLog;
...
public class OperationLogAspect {
    ...
    public void doBefore(JoinPoint joinPoint) {
        try {
            ...
            //*========数据库日志=========*//
            Log log = new Log();
            log.setAppName(getMethodDescription(joinPoint));
            log.setUsername("MR");
            log.setLogType(0);
...
//     * @throws Throwable
//     */
//    @Around("@annotation(com.mr.annotation.OperationLog)")
...
//    }
     ...
     * @throws Exception
     */
    private static String getModelAppName(JoinPoint joinPoint)
            throws Exception {
        String description = "";
