package com.mr.data.modules.api.xls.export.impl;
...
import com.mr.data.modules.api.xls.export.service.IFileExportor;
import com.mr.data.modules.api.xls.util.ReflectionUtils;
    ...
    private static void setCellValue(Object obj, Cell cell) throws FileExportException {
        if (obj != null) {
            ...
            if (classType.endsWith("String"))
                ...
                cell.setCellValue(com.mr.data.modules.api.xls.util.DateUtil.dateToString((Date) obj, com.mr.data.modules.api.xls.util.DateUtil.YYYYMMDDHHMMSS));
